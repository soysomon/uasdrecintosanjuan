      ...
      <section className="main-content w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pb-9">
        ...
        >
          ...
          >
            ...
            <div id="resultadoContainer" className="mt-4">
              <AnimatePresence>
                <motion.div 
                  id="resultado" 
                  className="resultado mt-3 hidden"
            ...
            <motion.button
              id="downloadButton"
              className="w-full mt-4 bg-yellow-400 text-blue-900 font-semibold py-3 rounded-lg shadow-lg hidden"
