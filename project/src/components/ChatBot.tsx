...
const ChatBot: React.FC = () => {
  ...
  const welcomeOptions: MenuOption[] = [
    ...
    { key: '9', label: 'Hablar con un Agente' },
  ];
...
<a href="https://www.instagram.com/inafocamrd/?hl=es" target="_blank" style="color: #007bff;">@inafocamrd</a>`,
    ...
    '9': {
      ...
      options: [],
      responses: {
        '1': 'Espera mientras te ponemos en contacto con un agente...',
      },
    },
  };
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="chatbot-panel bg-white w-96 h-[500px] rounded-2xl shadow-2xl flex flex-col overflow-hidden" // Aplicamos la clase chatbot-panel
            >
